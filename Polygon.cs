    ...
    public class Polygon : AbstractPainter
    {
        ...
        public override void DrawDynamicFigure(MouseEventArgs e, PictureBox pictureBox)
        {
            ...
            for (int k = 0; k < points.Length; k += 2)
            {
                ...
                {
                    AbstractPainter.DrawLine(points[k], points[k + 1], points[0], points[1], pictureBox);
                }
                else
                {
                    AbstractPainter.DrawLine(points[k], points[k + 1], points[k+2], points[k+3], pictureBox);
                }
            }
        }
